...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(
                f"Numerical pipeline created for columns: {numerical_columns}")
            ...
            categorical_pipeline = Pipeline(
                steps=[
                    ...
                    # Scale the one-hot encoded values
                    ("scaler", StandardScaler(with_mean=False))
                ]
            )
            logging.info(
                f"Categorical pipeline created for columns: {categorical_columns}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(
                f"Applying preprocessor object on training dataframe and test dataframe")
